...
This is usually done by taking from the available data a  random $(1-p)$ proportion for the testing dataset and $p$ for the training dataset. For example $p=0.8$ is common.
